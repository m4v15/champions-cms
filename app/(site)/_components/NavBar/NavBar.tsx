...
const NavBar = (props: INavbarProps) => (
    <>
        <div className="border-gray mx-auto w-full border-b bg-gray-50 px-3 py-0">
            <div className="m-auto flex max-w-screen-lg flex-row flex-wrap items-center justify-between">
                ...
                <nav>
                    <ul className="navbar flex items-center text-xl font-medium">
                        {props.pages.map(page => (<li key={page.slug}>
                            <Link href={`/${page.slug}`} className="text-gray-500 hover:text-gray-900 mx-3">
                                {page.title}
                            </Link>
                        </li>))}
                        <li>
